...
def setOPT():
    ...
    parser.add_argument('--source', type=str,
                        default='/mnt/marathon/staticresource/record/chongqing201911/终点/终点_2019-11-10_09-44-51-660.mp4',
    ...
    parser.add_argument('--facenet-model-path', type=str, default='../20180402-114759',
                        help='miss facenet-model')
    parser.add_argument('--svc-path', type=str, default='../SVCmodel.pkl',
                        help='miss svc')
    parser.add_argument('--database-path', type=str, default='../Database.npz',
                        help='miss database')
...
if __name__ == "__main__":
    weights = '../weights/last.pt'  # yolov5权重
    output = '../inference/output'  # 输出文件保存位置
    source = "/mnt/marathon/staticresource/record/chongqing201911/终点/终点_2019-11-10_09-44-51-660.mp4"  # 输入检测文件

    picture_path = "../inference/images"  # 用户图片数据
    model_path = "../20180402-114759"  # facenet模型权重
    database_path = "../Database.npz"  # 打包成npz文件
    SVCpath = "../SVCmodel.pkl"  # 通过SVM训练保存到pkl
